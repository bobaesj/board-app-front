...
const Join = () => {
    ...
    const usernameCheck = useCallback(async () => {
        try {
            ...
            const response = await axios.post('http://211.188.55.132:9090/members/username-check', {
    ...
    const nicknameCheck = useCallback(async () => {
        try {
            ...
            const response = await axios.post('http://211.188.55.132:9090/members/nickname-check', {
